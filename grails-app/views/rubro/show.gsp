...
<html>
    ...
    <body>
        ...
        <div id="show-rubro" class="content scaffold-show" role="main">
            ...
            <f:display bean="rubro" />
            <g:form resource="${this.rubro}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.rubro}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
