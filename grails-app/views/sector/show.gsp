...
<html>
    ...
    <body>
        ...
        <div id="show-sector" class="content scaffold-show" role="main">
            ...
            <f:display bean="sector" />
            <g:form resource="${this.sector}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.sector}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
